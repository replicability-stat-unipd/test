...
```{r}
#| include: false
#source(here("_materials/02-meta-analysis", "scripts", "r-img.R"))
imgs <- readRDS(here("_materials", "02-meta-analysis", "objects", "r-imgs.rds"))
...
filor::show_file(here("_materials/02-meta-analysis/scripts/power-example.R"), how = "code")
```
...
sim <- readRDS(here("_materials/02-meta-analysis/objects/power-example.rds"))
...
```{r}
#| echo: false
oliveira2023 <- readRDS(here("_materials/02-meta-analysis/objects/oliveira2023_clean.rds"))
oliveira2023
```
...
```{r}
#| echo: false
dear2019 <- readRDS(here("_materials/02-meta-analysis/objects/dear2019_clean.rds"))
```
